...
#define BX_DARRAY_DECLARE(T, NAME)                                                         \
    ...
    static inline void bx_darray_##NAME##_reserve(bx_darray_##NAME* arr, size_t capacity)  \
    {                                                                                      \
        bx_darray_reserve(&arr->base, capacity);                                           \
    }                                                                                      \
    static inline void bx_darray_##NAME##_resize(bx_darray_##NAME* arr, size_t size)       \
    {                                                                                      \
        bx_darray_resize(&arr->base, size);                                                \
    }                                                                                      \
    static inline void bx_darray_##NAME##_remove_swap(bx_darray_##NAME* arr, size_t index) \
    {                                                                                      \
